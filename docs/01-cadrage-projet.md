...
- Dépôt GitHub : A compléter
- Date de démarrage : A compléter
...
Décrire ici vos choix : dépôt public ou privé, nommage, stratégie de tags, usage ou non d'un environnement local, usage ou non d'une VM personnelle.
